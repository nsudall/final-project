...
class Router {
    ...
    protected function handleMainRoutes() {
        ...
        if ($this->uriArray[1] === 'softball-view' && $_SERVER['REQUEST_METHOD'] === 'GET') {
            $mainController = new MainController();
            $mainController->softballView();
        }

        if ($this->uriArray[1] === 'concert-view' && $_SERVER['REQUEST_METHOD'] === 'GET') {
            $mainController = new MainController();
            $mainController->concertView();
        }

        if ($this->uriArray[1] === 'musical-view' && $_SERVER['REQUEST_METHOD'] === 'GET') {
            $mainController = new MainController();
            $mainController->musicalView();
        }
    }
