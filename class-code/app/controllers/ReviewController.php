...
class ReviewController
{
    ...
    public function reviewsView() {
        include '../public/assets/views/main/reviews-view.html';
        exit();
    }

    public function reviewsAddView() {
        include '../public/assets/views/main/reviews-add.html';
        exit();
    }

    public function reviewsDeleteView() {
        include '../public/assets/views/main/reviews-delete.html';
        exit();
    }

    public function reviewsUpdateView() {
        include '../public/assets/views/main/reviews-update.html';
        exit();
    }
